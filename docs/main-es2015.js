...
/* harmony import */ var _todos_todo_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./todos/todo.module */ "./src/app/todos/todo.module.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [], imports: [[
            ...
            _ngrx_store__WEBPACK_IMPORTED_MODULE_7__["StoreModule"].forRoot(_app_reducer__WEBPACK_IMPORTED_MODULE_10__["appReducers"]),
...
FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FooterComponent, selectors: [["app-footer"]], decls: 9, vars: 0, consts: [[1, "info"], ["href", "https://danielrdm5.github.io/mypresentation/index.html"]], template: function FooterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Angel D. Garc\u00EDa");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class TodoPageComponent {
    ...
    toggleAll() {
        ...
        this.store.dispatch(_todo_actions__WEBPACK_IMPORTED_MODULE_1__["toggleAll"]({ todosCompletados: this.todosCompletados }));
    }
}
...
TodoPageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TodoPageComponent, selectors: [["app-todo-page"]], decls: 9, vars: 0, consts: [[1, "todoapp"], [1, "main"], ["id", "toggle-all", "type", "checkbox", 1, "toggle-all", 3, "click"], ["for", "toggle-all"]], template: function TodoPageComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoPageComponent_Template_input_click_4_listener() { return ctx.toggleAll(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "limpiarCompletados", function() { return limpiarCompletados; });
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js");
...
const toggleAll = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[TODO] ToggleAll Todo', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const limpiarCompletados = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[TODO] Limpiar Completados');
...
const estadoInicial = [
    ...
    new _models_todo_model__WEBPACK_IMPORTED_MODULE_2__["Todo"]('Defeat Thanos'),
    new _models_todo_model__WEBPACK_IMPORTED_MODULE_2__["Todo"]('Contact Nick Fury'),
    new _models_todo_model__WEBPACK_IMPORTED_MODULE_2__["Todo"]('Go Shopping with Tony Stark'),
    new _models_todo_model__WEBPACK_IMPORTED_MODULE_2__["Todo"]('Date Blackwidow')
];
...
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_todo_actions__WEBPACK_IMPORTED_MODULE_1__["borrar"], (state, { id }) => state.filter(todo => todo.id !== id)), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_todo_actions__WEBPACK_IMPORTED_MODULE_1__["toggleAll"], (state, { todosCompletados }) => {
    return state.map(todo => {
        return Object.assign(Object.assign({}, todo), { completado: todosCompletados });
    });
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_todo_actions__WEBPACK_IMPORTED_MODULE_1__["limpiarCompletados"], state => state.filter(todo => !todo.completado)));
...
module.exports = __webpack_require__(/*! C:\DanielCode\ReduxAngular\03-todoApp\src\main.ts */"./src/main.ts");
